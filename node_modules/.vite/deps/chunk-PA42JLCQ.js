...
init_runtime();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/motion/dist/esm/entering/keyframes-motion.compiled.css";
...
var useSetTimeout = function useSetTimeout2() {
  ...
  var timeouts = (0, import_react4.useRef)([]);
  ...
  return (0, import_react4.useCallback)(function(handler, timeout) {
...
var ExitingContext = (0, import_react5.createContext)(emptyContext);
var wrapChildWithContextProvider = function wrapChildWithContextProvider2(child) {
  ...
  return import_react5.default.createElement(ExitingContext.Provider, {
...
var childrenToArray = function childrenToArray2(children) {
  var childrenAsArray = [];
  import_react5.Children.toArray(children).forEach(function(child) {
...
var ExitingPersistence = (0, import_react5.memo)(function(_ref) {
  ...
  var _useState = (0, import_react5.useState)([null, children]), _useState2 = _slicedToArray(_useState, 2), stateChildren = _useState2[0], setChildren = _useState2[1];
  var _useState3 = (0, import_react5.useState)([]), _useState4 = _slicedToArray(_useState3, 2), exitingChildren = _useState4[0], setExitingChildren = _useState4[1];
  var _useState5 = (0, import_react5.useState)(function() {
    return {
      appear,
      isExiting: false
    };
...
var useExitingPersistence = function useExitingPersistence2() {
  return (0, import_react5.useContext)(ExitingContext);
};
...
function useUniqueId() {
  var identifier = (0, import_react7.useRef)("");
...
// node_modules/@atlaskit/motion/dist/esm/entering/staggered-entrance.js
var StaggeredEntranceContext = (0, import_react8.createContext)(function() {
  return {
    isReady: true,
    delay: 0,
    ref: noop
...
var useStaggeredEntrance = function useStaggeredEntrance2() {
  ...
  var context = (0, import_react8.useContext)(StaggeredEntranceContext);
...
var EnteringMotion = function EnteringMotion2(_ref) {
  ...
  var _useState = (0, import_react9.useState)(appear), _useState2 = _slicedToArray(_useState, 2), hasAnimationStyles = _useState2[0], setHasAnimationStyles = _useState2[1];
...
var FadeIn = function FadeIn2(_ref) {
  ...
  return import_react10.default.createElement(keyframes_motion_default, {
    duration,
...
function Popper2(_ref) {
  ...
  var internalModifiers = (0, import_react17.useMemo)(function() {
  ...
  var mergedModifiers = (0, import_react17.useMemo)(function() {
    if (modifiers == null) {
...
function InternalPortal(props) {
  ...
  var container = (0, import_react18.useMemo)(function() {
...
function InternalPortalNew(props) {
  var zIndex = props.zIndex, children = props.children;
  var _useState = (0, import_react20.useState)(null), _useState2 = _slicedToArray(_useState, 2), atlaskitPortal = _useState2[0], setAtlaskitPortal = _useState2[1];
  ...
  var suspendedChildren = import_react20.default.createElement(import_react20.Suspense, {
    fallback: null
  }, children);
...
var useIsSubsequentRender = function useIsSubsequentRender2(mountStrategy) {
  var _useState = (0, import_react21.useState)(false), _useState2 = _slicedToArray(_useState, 2), isSubsequentRender = _useState2[0], setIsSubsequentRender = _useState2[1];
  var _useState3 = (0, import_react21.useState)(function() {
    return mountStrategy === "layoutEffect" ? useIsomorphicLayoutEffect : import_react21.useEffect;
...
function Portal(_ref) {
  ...
  return !fg("platform_design_system_team_portal_logic_r18_fix") ? isSubsequentRender ? import_react23.default.createElement(InternalPortal, {
    zIndex
  }, children) : null : import_react23.default.createElement(InternalPortalNew, {
    zIndex
  }, children);
}
...
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/tooltip/dist/esm/tooltip-container.compiled.css";

// node_modules/@atlaskit/tooltip/dist/esm/tooltip-primitive.js
var React12 = __toESM(require_react());
init_runtime();
var import_react24 = __toESM(require_react());
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/tooltip/dist/esm/tooltip-primitive.compiled.css";
...
//# sourceMappingURL=chunk-PA42JLCQ.js.map
