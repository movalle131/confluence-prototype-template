...
function LoadingSpinner(_ref2) {
  ...
  return import_react10.default.createElement(spinner_default, {
    size,
    label: ", Loading",
...
// node_modules/@atlaskit/button/dist/esm/old-button/loading-button.js
var _excluded4 = ["appearance", "isDisabled", "isSelected", "isLoading", "spacing"];
var LoadingButton = import_react11.default.forwardRef(function LoadingButton2(_ref, ref) {
  var appearance = _ref.appearance, isDisabled = _ref.isDisabled, isSelected = _ref.isSelected, _ref$isLoading = _ref.isLoading, isLoading = _ref$isLoading === void 0 ? false : _ref$isLoading, spacing = _ref.spacing, rest = _objectWithoutProperties(_ref, _excluded4);
  return import_react11.default.createElement(button_default, _extends({}, rest, {
    ref,
    appearance,
    "aria-disabled": isLoading || void 0,
    isDisabled,
    isSelected,
    overlay: isLoading ? import_react11.default.createElement(LoadingSpinner, {
      spacing,
      appearance,
      isDisabled,
      isSelected
...
function getCustomCss(_ref) {
  ...
  if (selector) {
    result = _objectSpread2(_objectSpread2({}, result), result[selector]);
  }
  if (isLoading) {
    result = _objectSpread2(_objectSpread2({}, result), result['&[data-has-overlay="true"]']);
  }
...
function defaultThemeFn(current, values2) {
  return current(values2);
}
var Theme2 = createTheme(function(themeProps) {
  return {
...
// node_modules/@atlaskit/button/dist/esm/old-button/custom-theme-button/custom-theme-button.js
var _excluded5 = ["appearance", "autoFocus", "isDisabled", "isSelected", "shouldFitContainer", "spacing", "isLoading", "onMouseEnter", "onMouseLeave", "onMouseDown", "onMouseUp", "onFocus", "onBlur", "theme"];
...
var CustomThemeButton = import_react12.default.memo(import_react12.default.forwardRef(function CustomThemeButton2(_ref2, ref) {
  ...
  var _useState = (0, import_react12.useState)(initial), _useState2 = _slicedToArray(_useState, 2), state = _useState2[0], setState = _useState2[1];
  var onMouseEnter = (0, import_react12.useCallback)(function(event) {
    setState(function(current) {
      return _objectSpread3(_objectSpread3({}, current), {}, {
        isHover: true
      });
    });
  ...
  var onMouseLeave = (0, import_react12.useCallback)(function(event) {
    setState(function(current) {
      return _objectSpread3(_objectSpread3({}, current), {}, {
        isHover: false,
        isActive: false
  ...
  var onMouseDown = (0, import_react12.useCallback)(function(event) {
    setState(function(current) {
      return _objectSpread3(_objectSpread3({}, current), {}, {
        isActive: true
      });
  ...
  var onMouseUp = (0, import_react12.useCallback)(function(event) {
    setState(function(current) {
      return _objectSpread3(_objectSpread3({}, current), {}, {
        isActive: false
      });
  ...
  var onFocus = (0, import_react12.useCallback)(function(event) {
    setState(function(current) {
      return _objectSpread3(_objectSpread3({}, current), {}, {
        isFocus: true
      });
  ...
  var onBlur = (0, import_react12.useCallback)(function(event) {
    setState(function(current) {
      return _objectSpread3(_objectSpread3({}, current), {}, {
        isFocus: false
      });
  ...
  return import_react12.default.createElement(theme_default2.Provider, {
    value: theme
  }, import_react12.default.createElement(theme_default.Consumer, null, function(_ref3) {
    var mode = _ref3.mode;
    return import_react12.default.createElement(theme_default2.Consumer, _extends({
      mode,
      state: getInteractionState(_objectSpread3(_objectSpread3({}, state), {}, {
        isLoading,
      ...
      return import_react12.default.createElement(button_base_default, _extends({}, restProps, {
        ref,
        overlay: isLoading ? import_react12.default.createElement(LoadingSpinner, restProps) : null,
...
function ButtonGroup(_ref) {
  ...
  }, import_react13.default.Children.map(import_react13.default.Children.toArray(children), function(child, idx) {
    if (!child) {
      return null;
    }
    return jsx(import_react13.Fragment, {
      key: idx
    }, child);
  }));
}
