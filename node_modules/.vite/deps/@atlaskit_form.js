...
} from "./chunk-7XDZG4AG.js";
import "./chunk-PJFXQFKG.js";
...
var require_error = __commonJS({
  "node_modules/@atlaskit/icon/glyph/error.js"(exports) {
    ...
    var ErrorIcon2 = (props) => _react.default.createElement(_base.IconFacade, Object.assign({
...
var require_success = __commonJS({
  "node_modules/@atlaskit/icon/glyph/editor/success.js"(exports) {
    ...
    var EditorSuccessIcon = (props) => _react.default.createElement(_base.IconFacade, Object.assign({
...
function Form(props) {
  ...
  var onSubmitRef = (0, import_react.useRef)(props.onSubmit);
...
init_runtime();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/form-header.compiled.css";
...
init_runtime();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/form-footer.compiled.css";
...
init_runtime();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/form-section.compiled.css";
...
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/field.compiled.css";
...
init_runtime();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/label.compiled.css";
...
init_runtime();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/required-asterisk.compiled.css";
...
function Field(props) {
  ...
  (0, import_react3.useEffect)(function() {
    if (typeof process !== "undefined" && true && !process.env.CI) {
...
var CheckboxField = function CheckboxField2(_ref) {
  ...
  return value !== void 0 ? import_react4.default.createElement(Field, _extends({}, rest, {
    defaultValue,
    isDisabled,
    isRequired,
    label,
    ...
    var _ref2$fieldProps = _ref2.fieldProps, fieldValue = _ref2$fieldProps.value, otherFieldProps = _objectWithoutProperties(_ref2$fieldProps, _excluded2), others = _objectWithoutProperties(_ref2, _excluded3);
    return children(_objectSpread2({
      fieldProps: _objectSpread2(_objectSpread2({}, otherFieldProps), {}, {
  ...
  }) : import_react4.default.createElement(Field, _extends({}, rest, {
    ...
    var _ref3$fieldProps = _ref3.fieldProps, fieldValue = _ref3$fieldProps.value, otherFieldProps = _objectWithoutProperties(_ref3$fieldProps, _excluded4), others = _objectWithoutProperties(_ref3, _excluded5);
    return children(_objectSpread2({
      fieldProps: _objectSpread2(_objectSpread2({}, otherFieldProps), {}, {
...
var RangeField = function RangeField2(_ref) {
  ...
  return import_react5.default.createElement(Field, _extends({}, strippedProps, {
    defaultValue,
    id,
    isDisabled,
    label,
...
init_esm();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/messages.compiled.css";
...
var Message = function Message2(_ref2) {
  ...
  var _useState = (0, import_react6.useState)(isWrapper), _useState2 = _slicedToArray(_useState, 2), shouldRenderContent = _useState2[0], setShouldRenderContent = _useState2[1];
  var messageRef = (0, import_react6.useRef)(null);
  var _useState3 = (0, import_react6.useState)(isWrapper), _useState4 = _slicedToArray(_useState3, 2), hasMessageWrapper = _useState4[0], setHasMessageWrapper = _useState4[1];
  ...
  return React10.createElement("div", {
    ...
    id: fieldId,
    ref: messageRef,
    "aria-live": !hasMessageWrapper ? "polite" : void 0,
...
init_runtime();
import "/Users/movalle/Documents/GitHub/test-enhanced-app/node_modules/@atlaskit/form/dist/esm/fieldset.compiled.css";
