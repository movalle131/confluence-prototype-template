...
var Bleed = import_react13.default.memo(function(_ref) {
  ...
  return jsx("div", {
    ...
    className: resolvedStyles.static,
    css: [baseStyles4, (inline || all) && inlineBleedMap[inline || all], (block || all) && blockBleedMap[block || all], resolvedStyles.emotion],
    "data-testid": testId
  }, children);
});
...
var metric_text_default = MetricText;
...
var AnchorNoRef = function AnchorNoRef2(_ref, ref) {
  ...
  return jsx(
    ...
    _extends({
      ...
      css: [
        baseStyles6,
        fg("platform_design-system-team_anchor-positioning") ? positionStyles : void 0,
        focusRingStyles2,
        // eslint-disable-next-line @atlaskit/ui-styling-standard/no-imported-style-values -- Ignored via go/DSP-18766
        backgroundColor && backgroundColorStylesMap[backgroundColor],
        // eslint-disable-next-line @atlaskit/ui-styling-standard/no-imported-style-values -- Ignored via go/DSP-18766
...
var useLayoutEffect = typeof window === "undefined" ? import_react24.useEffect : import_react24.useLayoutEffect;
...
//# sourceMappingURL=chunk-PJFXQFKG.js.map
