 ...
 * - [Usage](https://atlassian.design/components/{packageName}/usage)
 */
export declare const JiraServiceManagementDataCenterIcon: ({ size, ...props }: import("./types").LogoProps) => import("react").JSX.Element;
/**
 ...
 * - [Usage](https://atlassian.design/components/{packageName}/usage)
 */
export declare const JiraServiceManagementDataCenterLogo: ({ size, ...props }: import("./types").LogoProps) => import("react").JSX.Element;
/**
